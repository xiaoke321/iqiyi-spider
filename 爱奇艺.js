...
function rsaFun(e) {
            var t = "ab86b6371b5318aaa1d3c9e612a9f1264f372323c8c0f19875b5fc3b3fd3afcc1e5bec527aa94bfa85bffc157e4245aebda05389a5357b75115ac94f074aefcd"
              ...
              , i = g.RSAUtils.encryptedString(n, encodeURIComponent(e)).replace(/\s/g, "-");
            return i
        }

console.log(rsaFun('qwert12358'))
// console.log(g.RSAUtils.getKeyPair('a','b','c'))
// console.log(a.RSAUtils)
